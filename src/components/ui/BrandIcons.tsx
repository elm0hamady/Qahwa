...
// lucide-react dropped third-party brand marks, so these are hand-rolled
// (standard glyphs, sized to match lucide's size-prop API).
...
export function InstagramIcon({ size = 16, ...props }: BrandIconProps) {
  return (
...
export function FacebookIcon({ size = 16, ...props }: BrandIconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" width={size} height={size} {...props}>
      <path d="M22 12.06C22 6.5 17.52 2 12 2S2 6.5 2 12.06c0 5.02 3.66 9.18 8.44 9.94v-7.03H7.9v-2.91h2.54V9.85c0-2.51 1.49-3.89 3.77-3.89 1.09 0 2.23.2 2.23.2v2.46h-1.26c-1.24 0-1.63.77-1.63 1.56v1.88h2.77l-.44 2.91h-2.33V22c4.78-.76 8.44-4.92 8.44-9.94Z" />
    </svg>
  );
}
